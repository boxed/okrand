...
class Meta:
    ...
    parts__list_okrand_logitem = dict(
    ...
    parts__edit_okrand_task__fields = dict(
    ...
    parts__create_okrand_task__fields__function = Field.choice(choices=lambda **_: [x.function for x in get_tasks()])
